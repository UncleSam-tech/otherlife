  ...
  return (
    <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px', overflowY: 'auto' }}>
      ...
      <div style={{ backgroundColor: 'var(--bg-surface-1)', padding: '16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)', display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px' }}>
          <div style={{ backgroundColor: 'var(--bg-surface-2)', padding: '10px 14px', borderRadius: 'var(--radius-sm)' }}>
            ...
            <div style={{ fontSize: '16px', fontWeight: 700, color: 'var(--accent-emerald)' }}>{ballControl.toFixed(0)} / 99</div>
          </div>
          <div style={{ backgroundColor: 'var(--bg-surface-2)', padding: '10px 14px', borderRadius: 'var(--radius-sm)' }}>
            <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>PACE</div>
            <div style={{ fontSize: '16px', fontWeight: 700, color: 'var(--accent-indigo)' }}>{pace.toFixed(0)} / 99</div>
          </div>
          <div style={{ backgroundColor: 'var(--bg-surface-2)', padding: '10px 14px', borderRadius: 'var(--radius-sm)' }}>
            <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>STAMINA</div>
            <div style={{ fontSize: '16px', fontWeight: 700, color: 'var(--accent-amber)' }}>{stamina.toFixed(0)} / 99</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: '12px' }}>
        ...
        >
          <Activity size={16} />
          <span>Attend Squad Training</span>
        </button>
        ...
        >
          <Shield size={16} />
          <span>Simulate Official Match</span>
        </button>
      </div>
    </div>
  );
